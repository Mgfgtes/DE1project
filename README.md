...
<p>Na obrázku níže se nachází celkové schéma top_level, kde jsou obsaženy všechny použité komponenty. Z laboratoří v průběhu semestru byly použity komponenty clock_enable a simple_counter</p>  
